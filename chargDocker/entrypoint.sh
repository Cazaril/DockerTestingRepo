...
sed -i "s|ORDERING = 'http://localhost:8080/DSProductOrdering'|ORDERING = 'http://$GLASSFISH_HOST:$GLASSFISH_PORT/ORDERING'|g" ./services_settings.py

sed -i "s|BILLING = 'http://localhost:8080/DSBillingManagement'|BILLING = 'http://$GLASSFISH_HOST:$GLASSFISH_PORT/BILLING'|g" ./services_settings.py

sed -i "s|RSS = 'http://localhost:8080/DSRevenueSharing'|RSS = 'http://$GLASSFISH_HOST:$GLASSFISH_PORT/RSS'|g" ./services_settings.py

sed -i "s|USAGE = 'http://localhost:8080/DSUsageManagement'|USAGE = 'http://$GLASSFISH_HOST:$GLASSFISH_PORT/USAGE'|g" ./services_settings.py
